...
from core.models import User, Task, TimeEntry, RoleEnum, TaskStatusEnum, TimeEntryKindEnum
...
def seed_demo():
    ...
    if not manager:
        manager = User(
            ...
            role=RoleEnum.MANAGER,   # ✅ Use Enum object
    ...
    for i in range(3):
        ...
        if not user:
            user = User(
                ...
                role=RoleEnum.EMPLOYEE,  # ✅ Use Enum object
    ...
    # 3️⃣ Create Task assigned to Employee 1
    task = Task(
        tenant_id=TENANT,
    ...
    # 4️⃣ Create Time Entries for Employee 1
